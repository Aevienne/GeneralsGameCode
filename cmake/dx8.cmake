...
target_compile_definitions(d3d8lib INTERFACE -DBUILD_WITH_D3D8 -DUSE_D3D8TO9)
if(MSVC)
...
target_link_libraries(d3d8lib INTERFACE d3d8to9 d3d9)

if(CMAKE_SIZEOF_VOID_P EQUAL 4)
    target_link_directories(d3d8lib INTERFACE ${dx8_SOURCE_DIR})
    ...
    target_link_libraries(d3d8lib INTERFACE d3dx8shim dinput8 dxguid)
endif()
